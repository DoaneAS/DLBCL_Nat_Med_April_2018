...
# measure <- "Pearson"
    ...
    #tk <- which(difslope == secondv)+1
      ...
      #}
		...
		plot(k.vector,sil, main ="Average silhouette value in each cluster",xlab = "k", ylab="silhouette width", type = "n", xaxt="n")
		...
		plot(k.vector,values[,1], main ="Cophenetic Coefficient in each cluster",xlab = "k", ylab="Cophenetic Coefficient", type = "n", xaxt="n")
